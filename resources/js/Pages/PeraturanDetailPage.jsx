    ...
    >
      ...
      <div className="relative pt-3.5 px-4 overflow-visible">
        ...
        <div className="relative z-10 flex items-center justify-between gap-2 pt-1 border-b border-slate-100 pb-3">
          ...
          {/* Status Pill */}
          <span className={`inline-flex items-center gap-1 px-2.5 py-0.5 rounded-full text-[9.5px] font-extrabold uppercase tracking-wider border shadow-2xs shrink-0 ${
            isUploaded 
              ...
              <div className="flex items-center gap-3 overflow-hidden">
                ...
                <div className="truncate">
                  <div className="flex items-center gap-2">
                    ...
                    <span className="inline-flex items-center gap-1 px-2 py-0.5 rounded-md bg-amber-400/20 text-amber-300 text-[10px] font-mono font-bold border border-amber-300/30 shrink-0">
