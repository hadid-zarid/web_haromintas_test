...
export const PanduanPage = () => {
  ...
  const guideSlides = [
    ...
    },
    {
      ...
      steps: [
        {
          title: 'Slot 1 & Slot 2: Berkas Awal Pemohon',
          desc: 'Pastikan Draft Rancangan Awal (Slot 1) dan Dokumen Analisis Konsepsi (Slot 2) telah terunggah dengan benar sebelum pleno.',
          tag: 'Pra-Harmonisasi',
          icon: Folder,
          highlight: 'bg-blue-50/70 border-blue-200 text-blue-950',
        },
        {
          title: 'Slot 3 & Slot 4: Hasil Rapat Pleno',
          desc: 'Setelah rapat pleno penyelarasan pasal bersama Pemda, unggah Matriks Perubahan Sandingan (Slot 3) dan Draft Bersih Hasil Harmonisasi (Slot 4).',
          tag: 'Hasil Pleno',
          icon: FileCheck2,
          highlight: 'bg-indigo-50/70 border-indigo-200 text-indigo-950',
        },
        {
          title: 'Slot 5: Surat Hasil Harmonisasi Kanwil',
          desc: 'Unggah Surat Resmi Hasil Harmonisasi bertanda tangan Kakanwil/Kadiv. Begitu Slot 5 terunggah, status otomatis berpindah ke "Fasilitasi".',
    ...
    },
    {
      ...
      steps: [
        ...
        {
          title: '3. Pengesahan Keputusan Akhir (Slot 7)',
          desc: 'Klik tombol "Terima & Terbitkan Surat Fasilitasi" untuk melampirkan surat keputusan akhir (Slot 7). Status regulasi otomatis berubah menjadi "Selesai (Tuntas)".',
