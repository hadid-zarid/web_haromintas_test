...
export const StatistikHarmonisasiSection = ({ initialData }) => {
  ...
  // Pagination state (default: 5 cards per page to prevent excessive vertical height)
  ...
  return (
    ...
    >
      ...
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 space-y-10">
        ...
        {/* =========================================================================
            1. EDITORIAL HEADER & METADATA BADGES
            ========================================================================= */}
        <div className="space-y-4">
          <div className="flex flex-wrap items-center justify-between gap-3">
            ...
            <div className="inline-flex items-center gap-2 rounded-xl border border-[#2B3056]/15 bg-[#2B3056]/5 px-3.5 py-1.5 text-xs font-extrabold uppercase tracking-wider text-[#2B3056]">
              <span className="flex h-2 w-2 rounded-full bg-[#FFC800] ring-4 ring-[#FFC800]/20" />
            ...
            <div className="flex flex-wrap items-center gap-2 text-xs">
              ...
              {/* Source Tag */}
              <span className="inline-flex items-center gap-1.5 rounded-lg border border-slate-200 bg-white px-3 py-1 font-medium text-slate-600 shadow-2xs">
                <Info className="h-3.5 w-3.5 text-slate-400" />
                <span>{data?.keterangan_sumber || 'Sumber: rekap 2025 yang diberikan'}</span>
              </span>
          ...
          {/* Fetch Error Notice (if any, preserving valid cached data) */}
          {fetchError && (
        ...
        {/* =========================================================================
            2. DUA PANEL RINGKASAN ASIMETRIS (RANPERDA VS RANPERKADA)
            ========================================================================= */}
        <div className="grid gap-6 lg:grid-cols-12">

          {/* Panel Ranperda (ProPem) - 5 Cols on LG */}
          <div className="lg:col-span-6 rounded-3xl border border-blue-200/80 bg-gradient-to-br from-white via-blue-50/20 to-white p-6 sm:p-7 shadow-sm hover:shadow-md transition-shadow relative overflow-hidden">
            <div className="absolute top-0 right-0 h-28 w-28 bg-blue-500/5 rounded-bl-full pointer-events-none" />
            ...
            {/* Asymmetrical Metric Comparison */}
            <div className="mt-6 grid grid-cols-2 gap-4">
              ...
              <div className="rounded-2xl border border-blue-300/80 bg-blue-600 text-white p-4 shadow-sm">
          ...
          <div className="lg:col-span-6 rounded-3xl border border-amber-200/80 bg-gradient-to-br from-white via-amber-50/20 to-white p-6 sm:p-7 shadow-sm hover:shadow-md transition-shadow relative overflow-hidden">
            ...
            <div className="mt-6 grid grid-cols-2 gap-4">
              ...
              <div className="rounded-2xl border border-[#FFD82B] bg-[#2B3056] text-white p-4 shadow-sm">
            ...
            <div className="mt-5 rounded-2xl border border-amber-100 bg-amber-50/50 p-4 space-y-2">
              ...
              <div className="h-3 w-full bg-slate-200 rounded-full overflow-hidden p-0.5">
                <div
                  className="h-full bg-gradient-to-r from-[#FFC800] to-[#E5A500] rounded-full transition-all duration-700"
        ...
        <div className="rounded-2xl border border-slate-200 bg-white p-4 sm:p-5 shadow-xs space-y-4">
          <div className="flex flex-col lg:flex-row lg:items-center lg:justify-between gap-4">
            ...
            {/* Filter Wilayah, Sorting & Mode Switcher */}
            <div className="flex flex-wrap items-center gap-2 sm:gap-3">
              ...
              <div className="flex items-center gap-1.5 rounded-xl border border-slate-200 bg-white px-3 py-1.5 text-xs font-bold text-slate-700 shadow-2xs">
                ...
                <select
                  ...
                  className="bg-transparent font-bold text-[#2B3056] focus:outline-hidden cursor-pointer"
              ...
              {/* View Mode Toggle (Chart vs Accessible Table) */}
              <div className="flex items-center rounded-xl border border-slate-200 bg-white p-0.5 shadow-2xs">
                <button
                  ...
                  aria-label="Tampilan Jalur Perbandingan"
                >
                  <BarChart3 className="h-3.5 w-3.5" />
                  <span className="hidden sm:inline">Jalur Visual</span>
                </button>
                <button
                  type="button"
                  ...
                  aria-label="Tampilan Tabel Rekapitulasi Lengkap"
                >
              ...
              <button
                ...
                className="flex items-center gap-1.5 rounded-xl border border-slate-200 bg-white px-3 py-1.5 text-xs font-bold text-slate-700 hover:bg-slate-50 hover:text-[#2B3056] transition shadow-2xs cursor-pointer"
        ...
        {/* =========================================================================
            4. VISUAL UTAMA: JALUR PERBANDINGAN WILAYAH (PAIRED LANES) vs TABEL
            ========================================================================= */}
        {viewMode === 'chart' ? (
                    ...
                    <div className="space-y-1.5 pt-1">
                      ...
                      <div className="flex items-center gap-3 text-xs">
                        ...
                        <div className="flex-1 h-5 bg-slate-100 rounded-md overflow-hidden p-0.5 relative">
                          <div
                            className="h-full bg-[#3A4070] rounded-sm transition-all duration-500 flex items-center justify-end pr-2 text-[10px] font-mono font-bold text-white"
                      ...
                      <div className="flex items-center gap-3 text-xs">
                        ...
                        <div className="flex-1 h-5 bg-amber-50 rounded-md overflow-hidden p-0.5 relative">
                          <div
                            className={`h-full rounded-sm transition-all duration-500 flex items-center justify-end pr-2 text-[10px] font-mono font-bold ${
                              isSurplus
          ...
          /* =========================================================================
              ACCESSIBLE TABULAR RECAPITULATION VIEW
             ========================================================================= */
