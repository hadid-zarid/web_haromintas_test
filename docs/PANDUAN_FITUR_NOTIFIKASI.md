...
Dalam proses harmonisasi dan fasilitasi rancangan peraturan daerah (Ranperda/Ranperkada), terdapat kolaborasi lintas instansi antara **Tim Kerja Kanwil Kemenkum Riau**, **Biro Hukum Setda Provinsi Riau**, dan pemantauan oleh **Pimpinan Kanwil (Kakanwil & Kadiv)**.

Fitur **Notifikasi Terintegrasi** ini dibangun dengan tujuan:
- **Menghilangkan Bottleneck Komunikasi**: Memberitahu Biro Hukum secara otomatis ketika berkas harmonisasi Kanwil (5 dokumen) telah lengkap dan siap difasilitasi.
...
```
[ Tim Kerja Mengunggah Dokumen Harmonisasi (Dokumen 1-5 Lengkap) ]
                               │
                               ▼
...
2. **`PermohonanController@uploadDokumen`**:
   Memicu `NotifikasiService::notifyBiroHukum()` saat dokumen 1 s.d. 5 telah lengkap terisi.
...
1. **Template Notifikasi Alur Kerja (`emails.notifikasi_alur_kerja`)**:
   ...
   - Footer alamat resmi Kanwil Kemenkum Riau.
...
| **6** | **Trigger Notifikasi Biro Hukum (5 Dokumen Lengkap)** | 1. Login sebagai Tim Kerja.<br>2. Buka permohonan yang berstatus Draf Awal.<br>3. Unggah seluruh berkas hingga Dokumen 1 s.d. 5 terisi lengkap.<br>4. Login sebagai Biro Hukum. | Tim Kerja ➔ Biro Hukum | Biro Hukum menerima notifikasi in-app baru: *"Permohonan Siap Difasilitasi: Dokumen harmonisasi Kanwil lengkap 5 dokumen"*. | [ ] Pass<br>[ ] Fail |
