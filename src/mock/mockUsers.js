...
export const MOCK_USERS = [
  {
    ...
    role: ROLES.PROJA_1,
    unit: 'Kanwil Kemenkumham Riau - Tim Proja 1',
    email: 'proja1.riau@kemenkumham.go.id',
  ...
  },
  {
    ...
    role: ROLES.PROJA_2,
    unit: 'Kanwil Kemenkumham Riau - Tim Proja 2',
    email: 'proja2.riau@kemenkumham.go.id',
  ...
  },
  {
    ...
    role: ROLES.PROJA_3,
    unit: 'Kanwil Kemenkumham Riau - Tim Proja 3',
    email: 'proja3.riau@kemenkumham.go.id',
  ...
  },
  {
    ...
    role: ROLES.KAKANWIL,
    unit: 'Kepala Kantor Wilayah Kemenkumham Riau',
    email: 'kakanwil.riau@kemenkumham.go.id',
  ...
  },
  {
    ...
    role: ROLES.KADIV,
    unit: 'Kepala Divisi Pelayanan Hukum & HAM Riau',
    email: 'kadiv.yankum.riau@kemenkumham.go.id',
