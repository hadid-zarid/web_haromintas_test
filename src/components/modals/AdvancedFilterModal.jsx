  ...
  return (
    ...
    >
      <div className="space-y-4">
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
          <div>
            ...
            <select
              ...
              className="w-full text-xs p-2.5 bg-white border border-slate-300 rounded-lg outline-none focus:ring-2 focus:ring-blue-900"
            >
          ...
          <div>
            <label className="block text-xs font-semibold text-slate-700 mb-1">Status Progres</label>
            <select
          ...
          <div>
            <label className="block text-xs font-semibold text-slate-700 mb-1">Jenis Peraturan</label>
            <select
          ...
          <div>
            <label className="block text-xs font-semibold text-slate-700 mb-1">Tim Proja</label>
            <select
        ...
        <div>
          <label className="block text-xs font-semibold text-slate-700 mb-1">Rentang Tanggal Pembaruan</label>
          <div className="grid grid-cols-2 gap-2">
            <input
              type="date"
              value={localFilters.startDate || ''}
              onChange={(e) => setLocalFilters({ ...localFilters, startDate: e.target.value })}
              className="w-full text-xs p-2 border border-slate-300 rounded-lg focus:ring-2 focus:ring-blue-900"
            />
            <input
              type="date"
        ...
        <div className="pt-4 border-t border-slate-200 flex items-center justify-between">
          ...
          <div className="flex items-center gap-2">
            ...
            <button
              type="button"
              onClick={handleApply}
              className="px-4 py-2 text-xs font-bold text-white bg-blue-900 hover:bg-blue-950 rounded-lg flex items-center gap-1 transition-all shadow-sm"
            >
